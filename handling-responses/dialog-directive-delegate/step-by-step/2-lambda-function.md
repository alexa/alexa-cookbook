...
1.  **Upload the provided code.** We have provided the code for this skill on [GitHub](https://github.com/alexa/alexa-cookbook/archive/master.zip).  
  1.1. From the Code entry type box, choose "Upload a .ZIP file"

  1.1. Clone the project and package the skill

   1.1.1. go to https://github.com/alexa/alexa-cookbook

   1.1.1. clone or download the zip file and extract the files. This sample makes use of the [delegate directive](https://developer.amazon.com/public/solutions/alexa/alexa-skills-kit/docs/dialog-interface-reference#directives) and you can learn more about its [states and dialog flow](https://developer.amazon.com/public/solutions/alexa/alexa-skills-kit/docs/dialog-interface-reference#details) in the documentation

   1.1.1. from the command prompt or terminal:
      navigate to the \handling-responses\dialog-directive-delegate\src folder and type ```npm install```

   1.1.1. zip the files in the src folder (DO NOT include the parent src folder itself)

  1.1. Back on AWS.Amazon.com, click the upload button and upload your zip file.
